...
# Linked directories
set :linked_dirs, %w{web/app/uploads web/app/wfcache web/app/plugins/bwp-minify/cache web/app/plugins/bwp-minify/min web/app/aiowps_backups web/app/plugins/ad-injection-data web/app/plugins/sumome web/app/plugins/stripe-checkout-pro web/app/plugins/fanciest-author-box web/app/plugins/pinterest-pin-it web/app/opcache}
# Linked files
