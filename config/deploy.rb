...
# Linked directories
set :linked_dirs, %w{web/app/uploads web/app/w3tc-config web/app/aiowps_backups web/app/plugins/ad-injection-data web/app/plugins/fanciest-author-box web/app/plugins/pinterest-pin-it}
