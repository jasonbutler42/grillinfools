<div class="byline">
	<span class="meta meta-author vcard"><?php echo __('author', 'roots'); ?> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" rel="author" class="fn"><i><?php echo get_the_author(); ?></i></a></span>
