...
<?php else: ?>
    <span class="meta meta-author vcard"><?php echo __('author', 'roots'); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="url fn n"><?php the_author_meta( 'display_name' ); ?></a><span class="org">GrillinFools</span><span class="role">Author</span></span>
<?php endif; ?>
