...
<?php else: ?>
    <span class="meta meta-author vcard"><?php echo __('author', 'roots'); ?> <i><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="url fn"><?php the_author_meta( 'display_name' ); ?></a></i></span>
<?php endif; ?>
