<header class="banner navbar navbar-default navbar-static-top navbar-mobile" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"><span class="logo"><?php include(get_template_directory() . "/assets/img/logo.svg"); ?><img class="logo-svg-alt" src="<?php echo get_template_directory_uri() . "/assets/img/logo-large.png"; ?>" alt="logo" title=""><?php bloginfo('name'); ?></span></a>
